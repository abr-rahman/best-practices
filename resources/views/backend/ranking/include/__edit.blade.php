                ...
                <form id="rankingEditForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="popup-body-text">
                        ...
                        <div class="site-input-groups">
                            ...
                            <div class="input-group joint-input">
                                <input type="number" class="form-control min_invest" name="min_invest" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Team Minimum Invest:') }}</label>
                            <div class="input-group joint-input">
                                <input type="number" class="form-control team_min_invest" name="team_min_invest" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Minimum Direct Referral:') }}</label>
                            <div class="input-group joint-input">
                                <input type="number" class="form-control min_referral" name="min_referral" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
