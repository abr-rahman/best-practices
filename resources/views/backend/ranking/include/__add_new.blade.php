                ...
                <div class="popup-body-text">
                    ...
                    <form action="{{ route('admin.ranking.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="site-input-groups">
                            ...
                            <div class="input-group joint-input">
                                <input type="number" class="form-control" name="min_invest" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Team Minimum Invest:') }}</label>
                            <div class="input-group joint-input">
                                <input type="number" class="form-control" name="team_min_invest" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Minimum Direct Referral:') }}</label>
                            <div class="input-group joint-input">
                                <input type="number" class="form-control" name="min_referral" oninput="this.value = validateDouble(this.value)">
                            </div>
                        </div>
                        <div class="site-input-groups">
