...
class GatewaySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $paymongoCredentials = [
            'api_key' => 'https://api.paymongo.com/v1/checkout_sessions',
            'password' => 'A.rahman542$',
            ...
            ->insert(
                [
                    ...
                    [
                        ...
                        'name' => 'Paymongo',
                        'logo' => 'global/gateway/paymongo.png',
                        'type' => 'auto',
                        'charge' => 0,
                        'charge_type' => 'fixed',
                        'minimum_deposit' => 0,
                        ...
                        'rate' => 1,
                        'status' => true,
                        'credentials' => json_encode($paymongoCredentials),
                        'supported_currencies' => json_encode($paymongoCurrency),
                        'currency' => 'PHP',
                        'currency_symbol' => '$',
                    ],
                ]
