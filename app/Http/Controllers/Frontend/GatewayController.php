...
//    ============== Payment Success ===========================
    ...
    public function paymongoSuccess(Request $request)
    {
        ...
        $secret_key = 'sk_test_xfvo4yf2n1MSZQN4qC5xQqBi';
        $pass = 'A.rahman542$';

        $response = Curl::to('https://api.paymongo.com/v1/checkout_sessions/' . $sessionId)
            ->withHeader('accept: application/json')
            ->withHeader('Authorization: Basic ' . base64_encode($secret_key . ':' . $pass))
            ->asJson()
            ->get();
    ...
    protected function directGateway($gateway, $txnInfo)
    {
        ...
        elseif ($gateway == 'coinpayments') {
            ...
            $req = array(
                ...
                'buyer_email' => gateway_info('coinpayments')->buyer_email,
                'item_name' => 'Order',
            ...
            $data = [
                'data' => [
                    'attributes' => [
                        ...
                        'success_url' => route('gateway.paymongo.success', ['reftrn' => Crypt::encryptString($txnInfo->tnx)]),
                        'cancel_url' => route('status.cancel'),
                        'description' => $txnInfo->description
                    ],
                ]
